...
static const Array<TestInfo, 118> Tests{
...
static const Vector<SkipTestRange> UCodeVmSkipTests = {{118, Tests.size()}};
static const Vector<SkipTestRange> C89SkipTests = {{118, Tests.size()}};
