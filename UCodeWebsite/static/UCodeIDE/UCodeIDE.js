...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '../Output/UCodeIDE/Web/Debug/UCodeIDE.data';
      var REMOTE_PACKAGE_BASE = 'UCodeIDE.data';
...
Module['FS_createPath']("/", "wasmassets", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_../Output/UCodeIDE/Web/Debug/UCodeIDE.data');

      };
      Module['addRunDependency']('datafile_../Output/UCodeIDE/Web/Debug/UCodeIDE.data');
    ...
    loadPackage({"files": [{"filename": "/wasmassets/imgui.ini", "start": 0, "end": 1913}], "remote_package_size": 1913});
...
var ASM_CONSTS = {
  683700: () => { addEventListener("keydown", function(event) { if (event.keyCode === 32) { event.stopPropagation(); } }); }
};
...
// end include: preamble.js
  ...
  var _glfwSetWindowAttrib = (winid, attrib, value) => {
      var win = GLFW.WindowFromId(winid);
      if (!win) return;
