...
- [Syntax and semantics](./SyntaxAndSemantics.md)
   ...
   - [Keywords](./SyntaxAndSeamantics/Keywords.md)
     ...
     - [int/uint/sint,byte](./SyntaxAndSeamantics/Types/ints.md)
     ...
     - [this](./SyntaxAndSeamantics/keywords/this.md)
 
     - [static](./SyntaxAndSeamantics/keywords/static.md)

     - [thread](./SyntaxAndSeamantics/keywords/thread.md)

     - [eval](./SyntaxAndSeamantics/keywords/eval.md)

     - [invalid](./SyntaxAndSeamantics/keywords/invalid.md)

     - [new](./SyntaxAndSeamantics/keywords/new.md)

     - [Panic](./SyntaxAndSeamantics/keywords/Panic.md)

     - [type](./SyntaxAndSeamantics/keywords/type.md)

     - [valid](./SyntaxAndSeamantics/keywords/valid.md)

     - [compiler](./SyntaxAndSeamantics/keywords/compiler.md)

     - [use](./SyntaxAndSeamantics/keywords/use.md)

     - [out](./SyntaxAndSeamantics/keywords/out.md)
 
     - [for](./SyntaxAndSeamantics/keywords/for.md)

     - [unq](./SyntaxAndSeamantics/keywords/unq.md)

     - [shr](./SyntaxAndSeamantics/keywords/shr.md)

     - [import](./SyntaxAndSeamantics/keywords/import.md)

     - [bitcast](./SyntaxAndSeamantics/keywords/bitcast.md)

   - [Memory Management](./SyntaxAndSeamantics/MemoryManagement.md)

   - [Inheritance](./SyntaxAndSeamantics/Concepts/inheritance.md)
   ...
   - [Generic](./SyntaxAndSeamantics/Concepts/generic.md)
